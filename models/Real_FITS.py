...
class Model(nn.Module):
    ...
    # SpectFlow: Frequency Interpolation Time Series Forecasting
    # This is the real value implementation of the original SpectFlow. 
    # Real_SpectFlow simulates the complex value multiplication with two layer of real value linear layer following
